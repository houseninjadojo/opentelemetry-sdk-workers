...
import { globalErrorHandler, unrefTimer, suppressTracing } from '@opentelemetry/core';
import {
  SpanProcessor,
  SpanExporter,
  ReadableSpan,
...
import id from './id';
import type { DatadogBufferConfig } from './types';
...
export class DatadogSpanProcessor implements SpanProcessor {
  ...
  public readonly logger: DiagLogger;
